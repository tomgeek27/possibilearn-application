...
\begin{figure}
	...
	\subfigure[Olivetti dataset]
	{
		\includegraphics[scale=.35]{../img/olivetti_var_ratio_pca_plot}
		\label{fig:olivetti_var_ratio_pca_plot}
	}
	\subfigure[AT\&T dataset]
	{
		\includegraphics[scale=.35]{../img/atet_var_ratio_pca_plot}
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{c|c|c|c|c|c|c}
			& \multicolumn{3}{c|}{Olivetti dataset}                       & \multicolumn{3}{c}{AT\&T dataset}                                               \\ \hline
			Dimensioni & Test(\%) & Train(\%) & \multicolumn{1}{l|}{Ratio var. (\%)} & Test(\%) & \multicolumn{1}{l|}{Train(\%)} & \multicolumn{1}{l}{Ratio var. (\%)} \\ \hline
			2          & 28.83    & 62.36      & 39.21  & 41.37     & 54.96                          & 28.6                                 \\
			5          & 61.25     & 84.56       & 54.99                                 & 68.25     & 92.59                           & 47.53                                 \\
			20         & 85.87     & 100.0       & 76.51                                 &     86.87     &                      99.9          & 69.31                                 \\
			50         & 78.5      & 100.0       & 87.4                                & 88.5     & 100.0                            & 81.15                                
		\end{tabular}%
	}
